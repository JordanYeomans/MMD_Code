...
def get_dialog_dict(param, is_test=False):
    ...
    if not is_test:
        ...
        preparedata.prepare_data(valid_dir_loc, vocab_file, vocab_stats_file, os.path.join(dump_dir_loc, "valid"), valid_data_file, isTrain=True)
    if test_state is not None:
        preparedata.prepare_data(test_dir_loc, vocab_file, vocab_stats_file, os.path.join(dump_dir_loc + "/test_data_file_state/", "test_" + test_state),
...
if __name__ == "__main__":
    data_dir = '/media/jordanyeomans/Jordan Yeomans/VQA/'
    ...
    if os.path.isfile(vocab_file):
        print('found existing vocab file in ' + str(vocab_file) + ', ... reading from there')
    preparedata.prepare_data(test_dir_loc, vocab_file, vocab_stats_file, os.path.join(dump_dir_loc, "test_smallest"), test_data_file, isTrain=True)
